...
describe('PATCH /api/v1/users/[username]', () => {
  ...
  test("With duplicated 'username'", async () => {
    const user1Response = await fetch(`${BASE_URL}/api/v1/users`, {
      method: 'POST',
      headers: {
    ...
    const user2Response = await fetch(`${BASE_URL}/api/v1/users`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  test("With duplicated 'email'", async () => {
    ...
    const response = await fetch(`${BASE_URL}/api/v1/users/email2`, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  test("With unique 'username'", async () => {
    ...
    const response = await fetch(`${BASE_URL}/api/v1/users/uniqueUser1`, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  test("With unique 'email'", async () => {
    ...
    const response = await fetch(`${BASE_URL}/api/v1/users/uniqueEmail1`, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  test("With new 'password'", async () => {
    ...
    const response = await fetch(`${BASE_URL}/api/v1/users/newPassword1`, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
      },
